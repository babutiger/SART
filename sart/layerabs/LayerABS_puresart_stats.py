...
from sart.layerabs.default_profiles.LayerABS_puresart_stats_vnncomp_6x100 import (
...
run_configured_variant = run_configured_puresart_stats_variant
...
def main(argv=None):
    run_variant_controller(
        description=(
            "Run the PureSART stats controller with any configured "
