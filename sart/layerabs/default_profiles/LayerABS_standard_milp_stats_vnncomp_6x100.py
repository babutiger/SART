# Canonical Standard MILP stats baseline entrypoint.
...
def forward_propagation_standard_milp_stats(
    weights,
    biases,
    input_size,
    hidden_sizes,
...
def run_standard_milp_stats_verification(
    d,
    ...
    run_layerabs_verification(
        ...
        network_cls=network,
        forward_propagation_fn=forward_propagation_standard_milp_stats,
...
def run_configured_standard_milp_stats_variant(variant_name, d=None):
    config = get_variant_config(variant_name)
    if d is None:
        d = config.default_delta
    run_standard_milp_stats_verification(d, variant_name=variant_name)


forward_propagation_puremilp_stats = forward_propagation_standard_milp_stats
run_puremilp_stats_verification = run_standard_milp_stats_verification
run_configured_puremilp_stats_variant = run_configured_standard_milp_stats_variant
