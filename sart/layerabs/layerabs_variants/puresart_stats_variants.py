...
VARIANTS: dict[str, PureSARTStatsVariant] = {
    "vnncomp_6x100": PureSARTStatsVariant(
        name="vnncomp_6x100",
    ...
    "cifar10_6x80": PureSARTStatsVariant(
        name="cifar10_6x80",
    ...
    "mnist_6x100": PureSARTStatsVariant(
        name="mnist_6x100",
...
def get_variant_config(name: str) -> PureSARTStatsVariant:
    ...
    try:
        ...
        raise KeyError(
            f"Unknown PureSART stats variant '{name}'. Known variants: {known}"
        ) from exc
