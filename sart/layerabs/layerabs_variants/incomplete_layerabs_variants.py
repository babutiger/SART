...
class IncompleteLayerABSVariant:
    name: str
    network_module: str
    model_path: str
...
VARIANTS: dict[str, IncompleteLayerABSVariant] = {
    "mnist_10x80": IncompleteLayerABSVariant(
        name="mnist_10x80",
        ...
        result_prefix="mnist_new_10x80_incomplete_layerabs_number_result",
        default_delta=0.015,
        property_count=100,
    ),
    "mnist_5x50": IncompleteLayerABSVariant(
        name="mnist_5x50",
        ...
        result_prefix="mnist_new_5x50_incomplete_layerabs_number_result",
        default_delta=0.018,
        property_count=100,
    ),
    "mnist_5x80": IncompleteLayerABSVariant(
        name="mnist_5x80",
        ...
        result_prefix="mnist_new_5x80_incomplete_layerabs_number_result",
        default_delta=0.019,
        property_count=100,
    ),
    "mnist_6x100": IncompleteLayerABSVariant(
        name="mnist_6x100",
        ...
        result_prefix="mnist_new_6x100_incomplete_layerabs_number_result",
        default_delta=0.019,
        property_count=100,
    ),
    "mnist_9x100": IncompleteLayerABSVariant(
        name="mnist_9x100",
        ...
        result_prefix="mnist_new_9x100_incomplete_layerabs_number_result",
        default_delta=0.018,
        property_count=100,
    ),
    "mnist_9x200": IncompleteLayerABSVariant(
        name="mnist_9x200",
        ...
        result_prefix="mnist_new_9x200_incomplete_layerabs_number_result",
        default_delta=0.018,
        property_count=100,
    ),
    "cifar10_5x50": IncompleteLayerABSVariant(
        name="cifar10_5x50",
        network_module="sart.verify.mnist_new_10x80.deeppoly_mnist_new_10x80",
        ...
        result_prefix="cifar_new_5x50_incomplete_layerabs_number_result",
        default_delta=0.010,
        property_count=100,
        recursion_limit=100000,
    ),
    "cifar10_6x80": IncompleteLayerABSVariant(
        name="cifar10_6x80",
        network_module="sart.verify.mnist_new_10x80.deeppoly_mnist_new_10x80",
        ...
        result_prefix="cifar_new_6x80_incomplete_layerabs_number_result",
        default_delta=0.004,
        property_count=100,
        recursion_limit=100000,
    ),
    "vnncomp_6x100": IncompleteLayerABSVariant(
        name="vnncomp_6x100",
        network_module="sart.verify.mnist_new_6x100.deeppoly_mnist_new_6x100",
        model_path="../models/VNNCOMP_ERAN/mnist_6_100_nat_flat.nnet",
        property_template="../vnncomp_eran_properties/vnncomp_eran_mnist_properties_6x100/mnist_property_{index}.txt",
        result_prefix="vnncomp_eran_6x100_incomplete_layerabs_number_result",
        default_delta=0.019,
        property_count=100,
        show_running_average=True,
    ),
    "vnncomp_6x200": IncompleteLayerABSVariant(
        name="vnncomp_6x200",
        network_module="sart.verify.mnist_new_6x100.deeppoly_mnist_new_6x100",
        model_path="../models/VNNCOMP_ERAN/mnist_6_200_nat_flat.nnet",
        property_template="../vnncomp_eran_properties/vnncomp_eran_mnist_properties_6x200/mnist_property_{index}.txt",
        result_prefix="vnncomp_eran_6x200_incomplete_layerabs_number_result",
        default_delta=0.019,
        property_count=100,
        show_running_average=True,
    ),
    "vnncomp_9x100": IncompleteLayerABSVariant(
        name="vnncomp_9x100",
        network_module="sart.verify.mnist_new_6x100.deeppoly_mnist_new_6x100",
        model_path="../models/VNNCOMP_ERAN/mnist_9_100_nat_flat.nnet",
        property_template="../vnncomp_eran_properties/vnncomp_eran_mnist_properties_9x100/mnist_property_{index}.txt",
        result_prefix="vnncomp_eran_9x100_incomplete_layerabs_number_result",
        default_delta=0.018,
        property_count=100,
        show_running_average=True,
    ),
...
def get_variant_config(name: str) -> IncompleteLayerABSVariant:
    try:
        return VARIANTS[name]
    except KeyError as exc:
        known = ", ".join(sorted(VARIANTS))
        raise KeyError(
            f"Unknown Incomplete-LayerABS variant '{name}'. Known variants: {known}"
        ) from exc
