"""Shared propagation entrypoints for the abstraction-enabled LayerABS(MILP) family."""
...
COMPLETE_MILP_REFINEMENT_RUNNERS = {
...
COMPLETE_MILP_COMPLETE_RUNNERS = {
...
def run_refinement_stage_propagation(
    ...
    return run_regular_propagation(
        ...
        save_deeppoly,
        l_mip_num,
        stage_runners=COMPLETE_MILP_REFINEMENT_RUNNERS,
...
def run_complete_stage_propagation(
    ...
    return run_regular_propagation(
        ...
        save_deeppoly,
        l_mip_num,
        stage_runners=COMPLETE_MILP_COMPLETE_RUNNERS,
        child_process_ids=_get_child_process_ids(),
        cleanup_callback=terminate_all_child_processes,
    )
