...
from sart.layerabs.default_profiles.LayerABS_puresart_mnist_10x80 import (
...
run_configured_variant = run_configured_puresart_variant
...
def main(argv=None):
    run_variant_controller(
        description=(
            "Run the PureSART baseline controller with any configured "
