...
from sart.layerabs.default_profiles.LayerABS_abstract_milp_stats_mnist_6x100 import (
    run_abstract_milp_stats_verification,
...
run_configured_variant = run_configured_abstract_milp_stats_variant


def main(argv=None):
    run_variant_controller(
        description=(
            "Run the abstraction-enabled LayerABS(MILP) stats controller "
