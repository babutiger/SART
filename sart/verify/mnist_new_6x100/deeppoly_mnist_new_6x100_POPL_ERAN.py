...
def test_robustness_number_poly(d):
    ...
    net = network()
    net.load_nnet("../../models/mnist_new_6x100/mnist_6_100_nat_flat.nnet")
    property_list = ["../../mnist_properties/mnist_properties_6x100/mnist_property_" + str(i) + ".txt" for i in
                     range(amount)]

    # if not os.path.isdir('../../result/original_result'):
    #     os.makedirs('../../result/original_result')
    # file = open("../../result/original_result/mnist_new_6x100_deeppoly_number_result_delta_"+ str(d) +"_"+ str(style_time) +".txt", mode="w+", encoding="utf-8")
...
if __name__ == "__main__":
    ...
    test_robustness_number_poly(0.019)
