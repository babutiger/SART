...
def cifar_robustness_radius():
    ...
    file = open("../../result/original_result/cifar_new_16x250_deeppoly_radius_result.txt", mode="w+", encoding="utf-8")
...
def test_robustness_number(d):
    ...
    if not os.path.isdir('../../result/original_result'):
        os.makedirs('../../result/original_result')
    file = open("../../result/original_result/cifar_new_16x250_deeppoly_number_result_delta_"+ str(d) +".txt", mode="w+", encoding="utf-8")
