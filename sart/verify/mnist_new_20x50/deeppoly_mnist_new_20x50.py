...
def mnist_robustness_radius():
    ...
    file = open("../../result/original_result/mnist_new_20x50_deeppoly_radius_result.txt", mode="w+", encoding="utf-8")
...
def test_robustness_number(d):
    ...
    if not os.path.isdir('../../result/original_result'):
        os.makedirs('../../result/original_result')
    file = open("../../result/original_result/mnist_new_20x50_deeppoly_number_result_delta_"+ str(d) +".txt", mode="w+", encoding="utf-8")
