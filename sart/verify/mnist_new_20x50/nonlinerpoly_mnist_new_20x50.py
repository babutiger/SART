...
def mnist_robustness_radius():
    ...
    property_list = ["../../mnist_properties/mnist_properties_20x50/mnist_property_" + str(i) + ".txt" for i in range(100)]

    if not os.path.isdir('../../result/original_result'):
        os.makedirs('../../result/original_result')
    file = open("../../result/original_result/mnist_new_20x50_nonlinerpoly_radius_result.txt", mode="w+", encoding="utf-8")
...
def test_robustness_number(d):
    ...
    if not os.path.isdir('../../result/original_result'):
        os.makedirs('../../result/original_result')
    file = open("../../result/original_result/mnist_new_20x50_nonlinerpoly_number_result_delta_"+ str(d) +".txt", mode="w+", encoding="utf-8")
