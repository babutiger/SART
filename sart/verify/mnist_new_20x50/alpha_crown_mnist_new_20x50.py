...
from sart.models.mnist_new_20x50.mnist_net_20x50_model import *  
...
def mnist_robustness_radius():
    model = NeuralNetwork()
    checkpoint = torch.load("../../models/mnist_new_20x50/mnist_net_new_20x50.pth", map_location=torch.device('cpu'))
    ...
    file = open("../../result/original_result/mnist_new_20x50_alpha_crown_radius_result.txt", mode="w+", encoding="utf-8")
...
def test_robustness_number(d):
    ...
    if not os.path.isdir('../../result/original_result'):
        os.makedirs('../../result/original_result')
    file = open("../../result/original_result/mnist_new_20x50_alpha_crown_number_result_delta_"+ str(d) +".txt", mode="w+", encoding="utf-8")
