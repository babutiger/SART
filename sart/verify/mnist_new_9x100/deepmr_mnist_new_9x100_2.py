...
def test_robustness_number(d):
    ...
    if not os.path.isdir('../../result/original_result'):
        os.makedirs('../../result/original_result')
    file = open("../../result/original_result/mnist_new_9x100_nonlinerpoly_number_result_delta_"+ str(d) +".txt", mode="w+", encoding="utf-8")
...
def test_robustness_number_mrlp(d):
    ...
    if not os.path.isdir('../../result/original_result'):
        os.makedirs('../../result/original_result')
    file = open("../../result/original_result/mnist_new_9x100_deepmr_number_result_delta_" + str(d) + "_" + str(style_time) + ".txt", mode="w+", encoding="utf-8")
