...
from sart.models.cifar_new_15x200.cifar_net_15x200_model import *  
...
def cifar_robustness_radius():
    ...
    model = NeuralNetwork()
    checkpoint = torch.load("../../models/cifar_new_15x200/cifar_net_new_15x200.pth", map_location=torch.device('cpu'))
    ...
    file = open("../../result/original_result/cifar_new_15x200_alpha_crown_radius_result.txt", mode="w+", encoding="utf-8")
...
def test_robustness_number(d):
    ...
    if not os.path.isdir('../../result/original_result'):
        os.makedirs('../../result/original_result')
    file = open("../../result/original_result/cifar_new_15x200_alpha_crown_number_result_delta_"+ str(d) +".txt", mode="w+", encoding="utf-8")
