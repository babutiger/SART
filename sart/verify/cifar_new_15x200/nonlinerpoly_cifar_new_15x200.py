...
def cifar_robustness_radius():
    net = network()
    net.load_nnet("../../models/cifar_new_15x200/cifar_net_new_15x200.nnet")
    property_list = ["../../cifar_properties/cifar_properties_15x200/cifar_property_" + str(i) + ".txt" for i in range(100)]

    if not os.path.isdir('../../result/original_result'):
        os.makedirs('../../result/original_result')
    file = open("../../result/original_result/cifar_new_15x200_nonlinerpoly_radius_result.txt", mode="w+", encoding="utf-8")
...
def test_robustness_number(d):
    net = network()
    net.load_nnet("../../models/cifar_new_15x200/cifar_net_new_15x200.nnet")
    property_list = ["../../cifar_properties/cifar_properties_15x200/cifar_property_" + str(i) + ".txt" for i in
                     range(100)]

    if not os.path.isdir('../../result/original_result'):
        os.makedirs('../../result/original_result')
    file = open("../../result/original_result/cifar_new_15x200_nonlinerpoly_number_result_delta_"+ str(d) +".txt", mode="w+", encoding="utf-8")
