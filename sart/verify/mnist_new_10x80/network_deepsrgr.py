...
def mnist_robustness_radius_lp():
    net = network()
    net.load_nnet("../../models/mnist_new_10x80/mnist_net_new_10x80.nnet")
    property_list = ["../../mnist_properties/mnist_properties_10x80/mnist_property_" + str(i) + ".txt" for i in range(9, 0, -1)]
...
def acasxu_robustness_radius_lp():
    ...
    file = open("../../result/original_result/acasxu_deepsrgr_radius_result_lp_" + str(style_time) + ".txt", mode="w+",
                encoding="utf-8")
